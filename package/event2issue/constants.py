...
ISSUE_AFFECTED_ID = 'affectedId'
ISSUE_CLOSING_DATE = 'closingDate'
ISSUE_ISSUE_TYPE = 'issueType'
EMPTY_CONTENT = 'emptycontent'
EVENT_AFFECTED_ENTITY_ID = 'AffectedEntity'
EVENT_EVENT_TYPE = 'EventType'
EVENT_EVENT_SEVERITY = 'EventSeverity'
