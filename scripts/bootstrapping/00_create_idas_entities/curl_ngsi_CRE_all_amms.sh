...
curl --request POST ${CB_HOST}:${CB_PORT}/ngsi10/updateContext  --header 'Content-Type: application/xml' $CURL_VERBOSE --data-binary @ngsi_cre_amms_x49.xml

sleep 1
curl --request POST ${CB_HOST}:${CB_PORT}/ngsi10/updateContext  --header 'Content-Type: application/xml' $CURL_VERBOSE --data-binary @ngsi_cre_amms_x84.xml
